---
title: IC26 - AEGEAN_ERP
sidebar_position: 1
---

**Component metadata:** **ID:** IC26 | **Area:** Pilot / External | **Partner:** AEGEAN | **Task:** T9.2
...
Simulated ERP of Aegean that acts as a participant to expose data regarding the MROs availabilities/capacities and also share information for the aircraft fleet.
