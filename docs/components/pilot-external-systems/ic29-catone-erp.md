---
title: IC29 - CATONE_ERP
sidebar_position: 4
---

## IC29 - CATONE_ERP

**Component metadata:** **ID:** IC29 | **Area:** Pilot / External | **Partner:** CATONE | **Task:** T9.5
...
Simulated ERP of CATONE that acts as participant to expose data regarding the warehouse state and real-time information of the trucks.
