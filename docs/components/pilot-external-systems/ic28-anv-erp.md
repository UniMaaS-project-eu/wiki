...
**Component metadata:** **ID:** IC28 | **Area:** Pilot / External | **Partner:** ANV | **Task:** T9.4
...
Simulated ERP of ANV that acts as participant to expose data regarding the suppliers' capabilities and also provides a REST API-like interface for real-time control of the printer.
