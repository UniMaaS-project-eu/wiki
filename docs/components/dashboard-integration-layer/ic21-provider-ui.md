...
**Component metadata:** **ID:** IC21 | **Area:** User-Facing | **Partner:** CEL | **Task:** T8.2
...
Provider user interface, form-oriented or drop-down menu, to create new assets and declare the Asset Descriptor, including the manufacturing domain.
