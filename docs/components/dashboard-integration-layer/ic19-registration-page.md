---
title: IC19 - Registration Page for Providers/Clients
sidebar_position: 3
---

## IC19 - Registration Page for Providers/Clients

**Component metadata:** **ID:** IC19 | **Name:** Registration Page for Providers/Clients | **Area:** User-Facing | **Partner:** CEL | **Task:** T8.2 | **TRL:** TBD
...
Registration page for providers and clients. Users choose a role and are assigned to a specific Keycloak realm, manufacturing domain, role, provider/consumer status, and token per participant.
