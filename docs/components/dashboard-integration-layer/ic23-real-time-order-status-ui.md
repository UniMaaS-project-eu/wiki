...
**Component metadata:** **ID:** IC23 | **Area:** User-Facing | **Partner:** CEL | **Task:** T8.2
...
Real-time UI connected with ArgoCD workflows to visualize all outputs of MSC execution for customers.
