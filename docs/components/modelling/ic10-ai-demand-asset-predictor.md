---
title: IC10 - AI Demand & Asset Predictor
sidebar_position: 3
---

## IC10 - AI Demand & Asset Predictor

**Component metadata:** **ID:** IC10 | **Area:** Modelling | **Partner:** ETS | **Task:** T5.2
...
The AI Demand & Asset Predictor uses AI techniques, for example deep neural networks, to forecast service demand and asset availability and to identify operational correlations between machines and sensors. Its AI-based predictions feed the model constructed per pilot, providing the predictive parameters required by the Formal Modelling Engine.
