---
title: IC4 - Federated Catalogue
sidebar_position: 4
---

## IC4 - Federated Catalogue

**Component metadata:** **ID:** IC4 | **Name:** Federated Catalogue | **Area:** Data Management | **Partner:** FLM | **Task:** T4.1 | **TRL:** TBD
...
The federated catalogue hosts metadata regarding the MSC-compatible RDF datasets shared to the UniMaaS Dataspace. Additionally, the UniMaaS Federated Catalogue automatically aggregates the list of datasets that each participant exposes to the data space.
