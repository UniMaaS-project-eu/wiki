---
title: IC2 - Digital Thread Component
sidebar_position: 2
---
...
Serves as the component that queries all Dataspace Participants to update the Knowledge Graph (KG) with the current state of the MaaS network. This agent orchestrates the data transfers through the Data Space and updates the central Knowledge Graph with new incoming data.
